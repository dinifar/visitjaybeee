...
<head>
    ...
    <title>Admin Page - Dashboard Template</title>
    <!--
            ...
            <div class="row tm-content-row tm-mt-big">
                    ...
                    <div class="bg-white tm-block h-100">
                        <div class="row">
                            <div class="col-md-8 col-sm-12">
                                <h2 class="tm-block-title d-inline-block">Admin</h2>

                            </div>
                            <div class="col-md-4 col-sm-12 text-right">
                                <!-- <a href="add-admin.html" class="btn btn-small btn-primary">Add New Admin</a> -->
                            </div>
                        </div>
                ...
                <div class="col-xl-4 col-lg-12 tm-md-12 tm-sm-12 tm-col">
                    <div class="bg-white tm-block h-100">
                        ...
                        <a href="add-admin.html" class="btn btn-primary tm-table-mt">Add New Category</a>
                    </div>
                </div>
            </div>
